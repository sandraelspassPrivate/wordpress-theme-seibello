  ...
  var MediaQuery = {
    ...
    _watcher: function _watcher() {
      ...
      $(window).on('resize.zf.mediaquery', function () {
        var newSize = _this7._getCurrentSize();

        if (newSize !== _this7.current) {
          // Broadcast the media query change on the window
          $(window).trigger('changed.zf.mediaquery', [newSize, _this7.current]);

          // Change the current media query
          _this7.current = newSize;
        }
      });
    }
  };
  ...
  $.fn.cookieBar = function (options) {
    ...
    return this.each(function () {
      ...
      if ($.cookie('cookiebar') != 'hide') {
        cookiebar.show(0, function () {
          $('.cookiebar').slideToggle("slow");
        });
      }

      // cookiebar.find(settings.closeButton).click(function() {
      $('.cookiebar-close').click(function () {
        $('.cookiebar').slideToggle("slow", function () {
          cookiebar.hide();
        });
